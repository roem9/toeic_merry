...
class Soal extends CI_Controller {
    ...
    public function id($id_tes){
        ...
        if($tes['status'] == "Berjalan"){
            ...
            if($soal['tipe_soal'] == "TOAFL" || $soal['tipe_soal'] == "TOEFL" || $soal['tipe_soal'] == "TOEIC"){
                if($soal['tipe_soal'] == "TOEFL") $data['table'] = "peserta_toefl";
                else if($soal['tipe_soal'] == "TOEIC") $data['table'] = "peserta_toeic";
            ...
            } elseif($data['soal']['tipe_soal'] == "TOEIC") {
                $this->load->view("pages/soal-toeic", $data);
            } else {
    ...
    public function add_jawaban_toeic(){
        ...
        $skor = skor_toeic($nilai_listening, $nilai_reading);
        ...
        $replacements = array(
            ...
            '$email' => $this->input->post("email"),
            '$jk' => $this->input->post("jk"),
            '$nilai_listening' => poin_toeic("Listening", $nilai_listening),
            '$nilai_reading' =>poin_toeic("Reading", $nilai_reading),
            '$tes' => $tes['nama_tes'],
            '$skor' => $skor,
            '$tgl_tes' => tgl_indo($tes["tgl_tes"], "lengkap"),
            '$tgl_pengumuman' => tgl_indo($tes["tgl_pengumuman"], "lengkap"),
            '$link' => "<a target='_blank' href='https://wa.me/+".$config[3]['value']."?text=Hi%20Kak%2C%20Saya%20".$nama."%20telah%20mengikuti%20".$nama_tes.".%20Saya%20ingin%20memiliki%20sertifikat%20digital%20hasil%20tes%20TOEIC%20Online'>Pesan Sertifikat Disini</a>",
        );
